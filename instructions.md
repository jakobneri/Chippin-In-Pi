...
All development tasks are managed through the **Arva Pilot** CLI tool. Commands follow the pattern:
...
- **Angular 21** with SSR support (`@angular/ssr`)
- **Tailwind CSS 4** with PostCSS
- **Zod** for runtime schema validation
- **msgpackr** for binary serialization in API responses
- **esbuild** for fast API bundling
- **AWS Lambda** with streaming response support
- **Commander** and **Inquirer** for CLI interactions
